#pragma once
#ifndef NEOOSC_SCREENITEM_H
#define NEOOSC_SCREENITEM_H
#include "../../libDaisy/src/ui/AbstractMenu.h"
 ...
 *  ScreenItemMenu uses the LookAndFeel system to draw draw the
 ...
 */
class ScreenItemMenu : public AbstractMenu
{
  public:
    /** Call this to initialize the menu. It's okay to re-initialize a 
     *  ScreenItemMenu multiple times, even while it's displayed on the UI.
