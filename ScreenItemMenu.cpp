...
void ScreenItemMenu::Init(const AbstractMenu::ItemConfig* items,
                          uint16_t                        numItems,
...
void ScreenItemMenu::SetOneBitGraphicsDisplayToDrawTo(uint16_t canvasId)
{
    canvasIdToDrawTo_ = canvasId;
}

void ScreenItemMenu::Draw(const UiCanvasDescriptor& canvas)
{
...
int ScreenItemMenu::GetTopRowHeight(int displayHeight) const
{
    return displayHeight / 2;
}

void ScreenItemMenu::DrawTextItem(OneBitGraphicsDisplay& display,
                                  bool                   isVertical,
...
void ScreenItemMenu::DrawCheckboxItem(OneBitGraphicsDisplay& display,
                                      bool                   isVertical,
                                      uint16_t               selectedItemIdx,
                                      uint16_t               numItems,
                                      const char*            itemText,
...
void ScreenItemMenu::DrawValueItem(OneBitGraphicsDisplay& display,
                                   bool                   isVertical,
                                   uint16_t               selectedItemIdx,
                                   uint16_t               numItems,
                                   const char*            itemText,
...
void ScreenItemMenu::DrawOpenUiPageItem(OneBitGraphicsDisplay& display,
                                        bool                   isVertical,
                                        uint16_t               selectedItemIdx,
                                        uint16_t               numItems,
                                        const char*            itemText) const
{
    ...
    DrawValueText(display, isVertical, "OK to edit", remainingBounds, false);
}

void ScreenItemMenu::DrawCloseMenuItem(OneBitGraphicsDisplay& display,
                                       bool                   isVertical,
                                       uint16_t               selectedItemIdx,
                                       uint16_t               numItems,
                                       const char*            itemText) const
{
    ...
    DrawValueText(display, isVertical, "OK to quit", remainingBounds, false);
}


void ScreenItemMenu::DrawTopRow(OneBitGraphicsDisplay& display,
                                bool                   isVertical,
                                int                    currentIndex,
                                int                    numItemsTotal,
                                const char*            text,
...
Rectangle
ScreenItemMenu::DrawUDArrowsAndGetRemRect(OneBitGraphicsDisplay& display,
...
Rectangle
ScreenItemMenu::DrawLRArrowsAndGetRemRect(OneBitGraphicsDisplay& display,
                                          Rectangle              topRowRect,
                                          bool                   leftAvailable,
...
void ScreenItemMenu::DrawValueText(OneBitGraphicsDisplay& display,
                                   bool                   isVertical,
                                   const char*            text,
                                   Rectangle              rect,
...
FontDef ScreenItemMenu::GetValueFont(const char*      textToDraw,
...
FontDef ScreenItemMenu::GetNameFont(const char*      textToDraw,
                                    const Rectangle& availableSpace) const
{
    (void)(textToDraw); // ignore unused variable warning
    if(availableSpace.GetHeight() < 10)
